...
|**Epic <br>/ User Story ID**|**Título**|**Descripción** |**Criterios<br>de <br>aceptación**|**Relacionado<br> con <br>(Epic ID)**|
| :- | :- | :- | :- | :- |
|**US01**|**Variedad de idiamas**|**Como** usuario **quiero** que la aplicación esté disponible al menos en idioma inglés o español **para** que alguien que solo sepa inglés y no sólo español.|<p>**Escenario 1:**</p><p><br>**Dado que** una persona puede ser de otra nacionalidad y no entender el idioma inicial de la aplicación, **cuando** desee cambiar el idioma, **entonces** se le presentarán dos opciones para elegir el idioma con el que se sienta más seguro y pueda continuar con sus reservas de entrevistas de manera efectiva.</p><p>**Escenario 2:**</p><p><br>**Dado que** una persona desea cambiar el idioma de la aplicación para adaptarse a sus preferencias lingüísticas, **cuando** acceda a la configuración o ajustes de la aplicación, **entonces** encontrará una opción para seleccionar el idioma deseado, teniendo como opciones inglés o español.</p>|**EP05**||
|**US02**|**Seguridad de cuenta**|<p>**Como** usuario **quiero** vincular un número de celular adicional </p><p>**para** que en caso pierda la cuenta principal pueda recuperarlo con este.</p><p></p>|<p>**Escenario 1:** El usuario opta por vincular un número de celular a la aplicación.<br>**Dado que** se encuentra navegando dentro de la aplicación, aparece un mensaje sugiriendo asegurar la cuenta con opciones de “SÍ” o “NO” ante la posibilidad de pérdida o robo del dispositivo.<br>**Cuando** el usuario elige la opción “SÍ”, se le ofrece la posibilidad de “Agregar un número de celular”.<br>**Entonces** debe completar los datos solicitados.<br>**Y** inmediatamente recibe un mensaje indicando que su número de celular ha sido vinculado a la aplicación con éxito.</p><p>**Escenario 2:<br>Dado que** el usuario ya tiene un número de celular vinculado a la aplicación y desea añadir un número adicional por seguridad.<br>**Cuando** selecciona la opción de seguridad de cuenta en la configuración de la aplicación.<br>**Entonces** se le presenta la opción de "Agregar un número de celular adicional".<br>**El usuario** introduce el nuevo número de celular y confirma su decisión.<br>**Inmediatamente después de confirmar**, recibe un mensaje de confirmación que indica: "Se ha vinculado exitosamente un número de celular adicional a su cuenta para mayor seguridad".</p><p>** </p>|**EP02**||
...
|**US04**|**Métodos de Pago**|**Como** usuario **quiero** realizar las transferencias con diferentes medios de pagos **para** poder reservar la entrevista en la aplicación.|<p>**Escenario 2.** El usuario quiere realizar pagos electrónicos.</p><p>**Dado que** el usuario quiere realizar los pagos por medio de tarjeta o algún otro medio.</p><p>**Cuando** ya terminó de seleccionar, le saldrá unas opciones para pagar con tarjeta de crédito u otro medio de pago.</p><p>**Entonces** el usuario tiene que llenar los datos si paga con tarjeta o si paga por otro medio</p><p></p><p>**Escenario 3:**</p><p>**Dado que** el usuario desea realizar el pago con tarjeta de crédito.</p><p>**Cuando** haya seleccionado la opción de pagar con tarjeta dentro de las opciones de pago disponibles.</p><p>**Entonces**, se le solicitará al usuario que llene los datos de su tarjeta, incluyendo el número de tarjeta, la fecha de vencimiento y el código de seguridad.</p><p>Una vez que el usuario haya ingresado los detalles de su tarjeta, deberá confirmar la transacción.</p><p>Después de confirmar, la aplicación procesará el pago y mostrará un mensaje de confirmación que indique que la transacción se ha completado con éxito.</p><p></p>|**EP04**||
|**US05**|**Visualización de calendario de entrevistas y anotaciones**|**Como** usuario de GetWork **Quiero** poder acceder a un calendario con mis entrevistas programadas y la capacidad de hacer anotaciones **Para** tener una visión clara de mis compromisos y preparación para entrevistas|<p>**Escenario 1:** Un usuario accede a su perfil en GetWork.<br>**Dado que** tiene entrevistas programadas,<br>**Cuando** navega a la sección de calendario,<br>**Entonces** observa un calendario con las fechas y horas de sus entrevistas, junto con la opción de añadir anotaciones.</p><p>**Escenario 2:** Un usuario desea agregar una nueva entrevista al calendario.<br>**Dado que** tiene una nueva entrevista programada,<br>**Cuando** selecciona la opción para agregar una nueva entrada al calendario,<br>**Entonces** puede ingresar la fecha, hora y detalles de la entrevista, y guardarla correctamente.</p>|**EP05**||
|**US06**|**Medio de comunicación**|**Como** usuario **quiero** visualizar en la aplicación **para** mantenerte al tanto de nuevas actualizaciones o alertas de cambios.|<p>**Escenario 1:** Un usuario es notificado sobre alguna actualización o advertencia.<br>**Dado que** se le informa al usuario sobre alguna actualización o advertencia respecto a los cambios,<br>**Cuando** está navegando en la aplicación o incluso cuando no lo está,<br>**Entonces** podrá tomar medidas al respecto con anticipación.</p><p>**Escenario 2:** Un usuario recibe notificaciones personalizadas.<br>**Dado que** la aplicación permite configurar alertas personalizadas basadas en las preferencias del usuario,<br>**Cuando** el usuario configura alertas para recibir notificaciones específicas,<br>**Entonces** recibe notificaciones que son relevantes solo para sus intereses y configuraciones, permitiéndole responder más eficazmente.</p>|**EP07**||
|**US07**|**Interfaz sencilla**|**Como** usuario **quiero** una interfaz sencilla **para** poder reservar con facilidad la entrevista.|<p>**Escenario 1:** Se desea una interfaz sencilla en toda la aplicación.<br>**Dado que** el usuario prefiere una navegación fácil y agradable visualmente,<br>**Cuando** esté en el proceso de reservar una entrevista,<br>**Entonces** no encontrará problemas con la interfaz, permitiéndole continuar con su reserva sin inconvenientes.</p><p>**Escenario 2:** El usuario requiere ajustes adicionales en la interfaz.<br>**Dado que** el usuario necesita personalizar los ajustes de accesibilidad,<br>**Cuando** acceda a las opciones de configuración de la interfaz,<br>**Entonces** podrá modificar elementos como tamaño de texto y contrastes, asegurando que la interfaz se adapte completamente a sus necesidades.</p>|**EP05**||
|**US08**|**Participación en GetWork Contest**|**Como** usuario de GetWork **quiero** poder participar en GetWork Contest y ver mi posición en el ranking **para** competir con otros usuarios y mejorar mis habilidades.|<p>**Escenario 1:** Se accede a la sección GetWork Contest.<br>**Dado que** se desea participar en el concurso semanal,<br>**Cuando** se selecciona la opción para unirse al concurso,<br>**Entonces** se pueden resolver los desafíos y la puntuación se refleja en el ranking.</p><p>**Escenario 2:** Se desea ver la posición actual en el ranking.<br>**Dado que** se quiere conocer la posición en el ranking,<br>**Cuando** se accede a la sección de ranking,<br>**Entonces** se puede ver la posición actual junto con otros usuarios y sus puntuaciones.</p>|**EP06**||
|**US09**|**Visualizar la landing page de la empresa**|<p>**Como** usuario interesado en los productos/servicios de la empresa,</p><p></p><p>**Quiero** poder ver la landing page para obtener información relevante y</p><p><br>**Para que**</p><p>decidir si quiero registrarme o contactar a la empresa.</p>|<p>**Escenario 1:** Visualización exitosa de la landing page.<br>**Dado que** la persona interesada accede a la landing page desde cualquier dispositivo,<br>**Cuando** ingresa a la página,<br>**Entonces** observa claramente la estructura de la página con una barra de navegación y las secciones principales.</p><p>**Escenario 2:** Problemas en la visualización de la landing page.<br>**Dado que** la persona interesada intenta acceder a la landing page desde un dispositivo y encuentra problemas de visualización,<br>**Cuando** se enfrenta a estos problemas,<br>**Entonces** comunica el inconveniente al equipo de soporte técnico para su pronta resolución.</p>|**EP05**||
...
|**US11**|**Entrenamiento especializado en desarrollo de algoritmos**|**Como** usuario **quiero** acceder a cursos y ejercicios especializados en desarrollo de algoritmos **para** mejorar mi capacidad de resolver problemas complejos durante las entrevistas técnicas.|<p>**Escenario 1:**</p><p>**Dado** que el usuario ha intentado registrarse varias veces sin éxito debido a un problema técnico en la aplicación,</p><p>**Cuando** el usuario intenta registrarse nuevamente utilizando un correo electrónico diferente,</p><p>**Entonces** la aplicación debe reconocer el intento anterior y proporcionar una opción para verificar el correo electrónico anterior o continuar con el nuevo.</p><p></p><p>**Escenario 2:**</p><p>**Dado que** un usuario ha completado exitosamente un curso sobre algoritmos de búsqueda en la plataforma,</p><p>**Cuando** el usuario intenta aplicar los conceptos aprendidos en un ejercicio práctico proporcionado por la plataforma,</p><p>**Entonces** la aplicación evalúa la solución propuesta por el usuario y proporciona retroalimentación específica sobre la eficiencia y la lógica del algoritmo implementado.</p><p></p><p></p><p></p>|**EP09**||
|**US12**|**Práctica de simulacros de entrevistas técnicas**|**Como** usuario de GetWork **quiero** tener acceso a simulacros de entrevistas técnicas **para** poder practicar y mejorar mis habilidades de entrevista.|<p>**Escenario 1:** <br>El usuario accede a la sección de simulacros de entrevistas. <br>**Dado que** el usuario quiere practicar una entrevista técnica simulada **Cuando** seleccione una categoría de entrevista (por ejemplo, desarrollo web, algoritmos) **Entonces** se le presentará un conjunto de preguntas y problemas para resolver</p><p>Escenario 2: <br>El usuario desea recibir retroalimentación después de completar un simulacro de entrevista. <br>**Dado que** el usuario ha completado un simulacro de entrevista técnica **Cuando** finalizó la sesión **Entonces** recibió retroalimentación sobre mi desempeño y áreas de mejora.</p><p></p><p></p><p></p>|**EP09**||
|**US13**|**Registrarse en la landing page**|<p>**Como** usuario interesado en los productos/servicios de la empresa,</p><p></p><p>**Quiero** poder registrarme en la landing page utilizando mi correo electrónico<br><br>**Para** acceder a funciones adicionales o recibir información relevante.</p>|<p>**Escenario 1**: Registro exitoso</p><p></p><p>**Dado que** el usuario está interesado en los productos/servicios de la empresa y desea registrarse en la landing page.</p><p></p><p>**Cuando** encuentre claramente la opción de registrarse y proporcione su correo electrónico y otros datos necesarios.</p><p></p><p>**Entonces** recibe un mensaje de confirmación indicando que mi registro ha sido exitoso.</p><p></p><p>**Escenario 2:** Error en el registro</p><p></p><p>**Dado que** el usuario está interesado en los productos/servicios de la empresa y desea registrarse en la landing page.</p><p></p><p>**Cuando** intente registrarse pero encuentra un problema, como datos incorrectos o falta de conexión.</p><p></p><p>**Entonces** recibe un mensaje de error indicando el problema y le dan instrucciones sobre cómo solucionarlo.</p><p></p><p></p>|**EP01**||
...
|**US15**|**Acceso a tutores especializados**|**Como** usuario de GetWork **quiero** tener acceso a tutores especializados con sus descripciones **para** recibir orientación personalizada y ayuda en mi preparación para entrevistas técnicas.|<p>**Escenario 1:** El usuario consulta la lista de tutores en GetWork.<br>**Dado que** el usuario necesita ayuda con un concepto técnico específico,<br>**Cuando** navega por la lista de tutores disponibles,<br>**Entonces** puede ver información detallada sobre cada tutor, incluyendo su experiencia y áreas de especialización.</p><p>**Escenario 2:** El usuario planifica una sesión de tutoría.<br>**Dado que** el usuario desea recibir orientación personalizada para su preparación de entrevista técnica,<br>**Cuando** selecciona un tutor y verifica su disponibilidad,<br>**Entonces** puede programar una sesión de tutoría con el tutor seleccionado en un horario que le convenga.</p>|**EP09**||
...
|**US17**|**Visualización de datos de usuario**|**Como** usuario de GetWork **quiero** poder ver y actualizar mis datos de perfil **para** mantener mi información actualizada y relevante en la plataforma.|<p>**Escenario 1:** El usuario actualiza su información de perfil en GetWork.<br>**Dado que** el usuario desea actualizar su información personal como nombre, correo electrónico, contraseña, entre otros,<br>**Cuando** accede a la sección de configuración de perfil,<br>**Entonces** puede ver sus datos actuales y realizar los cambios necesarios.</p><p>**Escenario 2:** El usuario revisa su actividad en la plataforma.<br>**Dado que** el usuario desea tener una visión general de su progreso y participación en GetWork,<br>**Cuando** accede a la sección de estadísticas o resumen de actividad,<br>**Entonces** puede ver datos como el número de simulacros de entrevistas realizados y desafíos completados.</p><p></p><p></p><p></p><p></p>|**EP05**||
...
|**US19**|**Enviar consulta a través del formulario de contacto**|<p>**Como** usuario interesado en obtener más información sobre los productos/servicios de la empresa, </p><p></p><p>**Quiero** poder enviar una consulta a través del formulario de contacto en la landing page.</p><p></p><p>**Para** poder contactarme con la empresa cuando lo requira.</p>|<p>**Escenario 1:** El usuario realiza un envío de consulta exitoso.<br>**Dado que** el usuario está interesado en los productos/servicios de la empresa y desea enviar una consulta,<br>**Cuando** encuentra claramente la opción de contacto e ingresa su nombre, correo electrónico, asunto y mensaje en el formulario,<br>**Entonces** envía el formulario y recibe una confirmación de que su consulta ha sido enviada con éxito.</p><p>**Escenario 2:** Error en el envío de la consulta.<br>**Dado que** el usuario está interesado en los productos/servicios de la empresa y desea enviar una consulta,<br>**Cuando** intenta enviar la consulta pero encuentra un problema, como campos obligatorios incompletos o interrupción de la conexión a internet,<br>**Entonces** recibe un mensaje de error indicando el problema y recibe instrucciones sobre cómo solucionarlo.</p>|**EP09**||
|**US20**|**Asesoramiento profesional y de carrera**|**Como** usuario **quiero** tener acceso a recursos y servicios de asesoramiento profesional y de carrera **para** que me ayuden a planificar mi trayectoria profesional, prepararse para entrevistas y tomar decisiones informadas sobre mi desarrollo profesional.|<p>**Escenario 1:** Un usuario recibe asesoramiento profesional.<br>**Dado que** el usuario ha completado una serie de cursos de preparación para entrevistas técnicas en la plataforma,<br>**Cuando** solicita una consulta de asesoramiento de carrera con un experto en desarrollo profesional,<br>**Entonces** el experto revisa el perfil del usuario, brinda orientación sobre las oportunidades laborales disponibles y sugiere estrategias para maximizar el potencial de empleabilidad del usuario en la industria tecnológica.</p><p>**Escenario 2:** Un usuario comparte su éxito profesional.<br>**Dado que** el usuario ha seguido las recomendaciones de desarrollo profesional proporcionadas por un asesor de carrera en la plataforma,<br>**Cuando** aplica con éxito a una oportunidad laboral y obtiene una oferta de trabajo deseada,<br>**Entonces** comparte su éxito en la comunidad, inspirando a otros a seguir el mismo camino y a utilizar los recursos disponibles en la plataforma para avanzar en sus carreras profesionales.</p>|**EP09**||
|**US21**|**Ver testimonios de clientes en la landing page**|<p>**Como** usuario interesado en los productos/servicios de la empresa, </p><p></p><p>**quiero** poder ver testimonios de clientes satisfechos en la landing page</p><p></p><p>**para** obtener una mejor comprensión de la experiencia de otros usuarios con la empresa.</p>|<p>**Escenario 1:** Un usuario visualiza testimonios exitosamente.<br>**Dado que** el usuario está en la página principal de la empresa y desea ver los testimonios de clientes satisfechos,<br>**Cuando** accede a la sección de testimonios,<br>**Entonces** ve una lista de testimonios que incluyen los nombres y experiencias de los clientes, presentados claramente.</p><p>**Escenario 2:** Error al cargar testimonios.<br>**Dado que** el usuario está en la página principal de la empresa y desea ver los testimonios de clientes satisfechos,<br>**Cuando** intenta acceder a la sección de testimonios,<br>**Pero** encuentra un problema técnico que impide la carga de los testimonios,<br>**Entonces** recibe un mensaje de error que indica que los testimonios no están disponibles en ese momento.</p>|**EP05**||
...
|**US23**|**Registrarse para obtener acceso exclusivo**|<p>**Como** usuario interesado en los productos/servicios de la empresa, </p><p></p><p>**Quiero** poder registrarme en la landing page utilizando un formulario de registro</p><p></p><p>**Para** acceder a funciones exclusivas o recibir beneficios adicionales.</p>|<p>**Escenario 1:** Registro exitoso.<br>**Dado que** un usuario se encuentra en la página principal de la empresa y desea registrarse para obtener acceso exclusivo,<br>**Cuando** introduce su correo electrónico y otros datos necesarios en el formulario de registro,<br>**Y** envía el formulario,<br>**Entonces** recibe una confirmación de que su cuenta ha sido creada exitosamente.</p><p>**Escenario 2:** Error al registrar.<br>**Dado que** un usuario está en la página principal de la empresa y desea registrarse para obtener acceso exclusivo,<br>**Cuando** intenta enviar el formulario de registro con información incorrecta o incompleta,<br>**Entonces** el sistema muestra un mensaje de error indicando que algunos campos están incorrectos o faltantes.</p>|**EP01**||
...
|**US28**|**Ver testimonios de clientes en la landing page**|<p>**Como** usuario interesado en los productos/servicios de la empresa, </p><p></p><p>**Quiero** poder ver testimonios de clientes satisfechos en la landing page </p><p></p><p>**Para** obtener una mejor comprensión de la experiencia de otros usuarios con la empresa.</p><p></p>|<p>**Escenario 1:** Visualización exitosa de testimonios.<br>**Dado que** un usuario está interesado en los productos/servicios de la empresa y desea ver testimonios de clientes,<br>**Cuando** accede a la página principal y busca la sección de testimonios,<br>**Entonces** encuentra claramente la sección de testimonios y puede ver los testimonios presentados de forma clara y ordenada, mostrando el nombre y la experiencia del cliente.</p><p>**Escenario 2:** Error al cargar testimonios.<br>**Dado que** un usuario está interesado en los productos/servicios de la empresa y desea ver testimonios de clientes,<br>**Cuando** accede a la página principal y busca la sección de testimonios,<br>**Pero** hay un problema técnico que impide la carga de los testimonios,<br>**Entonces** ve un mensaje de error indicando que no se pueden cargar los testimonios en este momento.</p>|**EP06**||
...
|TS11|Registrar Tutor|**Como** desarrollador que trabaja en la aplicación de CodePace <br>**Quiero** proporcionar una API<br>**Para** permitir que los tutores se inscriban en nuestra plataforma y puedan ofrecer sus servicios de tutoría a los usuarios|**Dado que** el tutor proporciona información válida de registro **Cuando** se envía una solicitud POST a /api/tutors con los detalles del tutor **Entonces** la API responde con un código de estado 201 (Created) Y el cuerpo de la respuesta contiene los detalles del tutor recién registrado|
|TS12|Obtener Planes|**Como** desarrollador que trabaja en la aplicación de CodePace <br>**Quiero** proporcionar una API<br>**Para** permitir que los usuarios puedan visualizar los diferentes planes disponibles en nuestra plataforma y seleccionar el que más les convenga|**Dado que** el usuario proporciona un token de autenticación válido **Cuando** se envía una solicitud GET a /api/plans con el token de autenticación **Entonces** la API responde con un código de estado 200 (OK) Y el cuerpo de la respuesta contiene una lista de planes disponibles|
|TS13|Registrar Participación en Concurso|**Como** desarrollador que trabaja en la aplicación de CodePace <br>**Quiero** proporcionar una API<br>**Para** permitir que los usuarios se inscriban en concursos de programación y demuestren sus habilidades técnicas|**Dado que** el usuario proporciona información válida para el concurso **Cuando** se envía una solicitud POST a /api/contest con los detalles del concurso **Entonces** la API responde con un código de estado 201 (Created) Y el cuerpo de la respuesta contiene los detalles de la participación en el concurso|
|TS14|Evaluación Técnica|**Como** desarrollador que trabaja en la aplicación de CodePace <br>**Quiero** proporcionar una API<br>**Para** permitir que los usuarios tomen evaluaciones técnicas y midan sus conocimientos en áreas específicas de programación|**Dado que** el usuario proporciona un token de autenticación válido y está listo para tomar la evaluación técnica **Cuando** se envía una solicitud POST a /api/technical-evaluation con el token de autenticación y los detalles de la evaluación **Entonces** la API responde con un código de estado 201 (Created) Y el cuerpo de la respuesta contiene los resultados de la evaluación técnica|
...
**4.1. Style Guidelines**
  - 4.1.1. General Style Guidelines
    ...
    **Paleta de colores:** Nuestra aplicación web y landing page, al estar dirigida a desarrolladores y estudiantes, cuenta con colores que denoten confianza, sean sobrios y formales,        por lo     que los colores principales que usaremos para GetWorkserán el blanco, Rojo, el negro y el gris. El blanco en representación del orden y limpieza, el azul la tranquilidad y     relajación      y el gris para la seriedad y modestia. El color principal de las letras será el negro para la formalidad pero también usaremos letras en color blano para un buen          contraste con el          fondo en donde se encuentra.
    ...
    ![image](https://github.com/CodepaceOrganization/Reports/assets/134337719/ddf615ac-e398-47e6-855b-4a13fec09730)
    ...
    **Tipografía:** La tipografía de nuestra aplicación será fácilmente legible y estética, por lo que se hará uso de la fuente Roboto para botones y títulos y Asap para textos, con          interlineado 1.15 con tamaño base 18px para desktop y para móvil tamaño 16px, no obstante, decidimos hacer uso de la unidad de medida “em” para que las letras sean escalables y           responsivas a la variedad de tamaños de pantalla. Los tamaños variarán según si son títulos principales, subtítulos o textos.
    ...
    ![image](https://github.com/CodepaceOrganization/Reports/assets/134337719/7a3f4de3-35f8-40a1-b34a-618df95a611b)

    ![image](https://github.com/CodepaceOrganization/Reports/assets/134337719/2e012775-90bc-41da-9614-a21a47b3780f)
...
![image](https://github.com/CodepaceOrganization/Reports/assets/130580982/e00855d7-b1eb-4171-97e5-9c24597009e9)
...
| **Prepared By**                    | Quispe Andia, Jeremy Joel                                                                                                                                                                                                                                                                     |
| Attendees                          | - Cachis Gonzales, Sebastian Nicolas (u202210846)<br>- Cruz Palomino, Adriano Sebastian (u202210697)<br>- Castillo Castillo, Alexander Jair (u202211390)<br>- Quispe Andia, Jeremy Joel (u202216279)<br>- Cabanillas Gora, Andrea Milagros (u202211711)<br>- Yauri Paucar, Elias (u202211817) |
| **Sprint 3  Review Summary**       | Creación de API RESTFUL con el lenguaje C# y Framework .NET                                                                                                                                                                                                                                   |
| **Sprint 3 Retrospective Summary** | Completar los diseños y estandarizar el lenguaje usado en el desarrollo y presentación las APIS RESTFUL                                                                                                                                                                                       |
| **Sprint Goal & User Stories**     |                                                                                                                                                                                                                                                                                               |
| **Sprint 3 Goal**                  | Creación de nuestra API REST para el funcionamiento de nuestra app web.                                                                                                                                                                                                                       |
...
| TS01                |<p>**Registrar Usuario**</p><p></p>|W01|Registrar usuario mediante una API| **Como** desarrollador que trabaja en la aplicación de CodePace **Quiero** poder registrar a un nuevo usuario mediante una API **Para** permitir que los usuarios se inscriban en nuestra plataforma y accedan a nuestros recursos de preparación para entrevistas técnicas.                              |2| Jeremy Quispe                   |Done|
| TS02                |**Iniciar Sesión de Usuario**	|W02|Quiero proporcionar una API para que los usuarios inicien sesión en sus cuentas.| **Como** desarrollador que trabaja en la aplicación de CodePace **Quiero** proporcionar una API para que los usuarios inicien sesión en sus cuentas **Para** permitirles acceder a su contenido personalizado y continuar con sus actividades de preparación para entrevistas técnicas	               |2| Sebastian Cachis                |To review|
| TS03                |<p>**Obtener Detalles del Usuario**	</p><p></p><p></p>|W03|<p>Obtener Detalles del Usuario mediante una API</p><p></p><p></p>| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API para que los usuarios recuperen sus detalles de perfil **Para** que puedan ver y actualizar su información personal cuando sea necesario.</p>                                                |1| <p>Jeremy</p><p>Quispe</p>      |Done|
| TS04                |<p>**Actualizar Detalles del Usuario**	</p><p></p><p></p>|W04|Actualizar Detalles del Usuario mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** que los usuarios actualicen su información de perfil Para que puedan mantener sus datos personales actualizados en nuestra plataforma</p>                                     |3| <p>Alexander</p><p>Castillo</p> |Done|
| TS05                |**Cerrar Sesión de Usuario**	|W05|Cerrar Sesión de Usuario mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** que los usuarios cierren sesión en sus cuentas para garantizar la seguridad y la privacidad de sus datos cuando finalicen su sesión en la plataforma</p>                      |2| Jeremy Quispe                   |Done|
| TS06                |**Recuperar Contraseña Olvidada**	|W06|Recuperar Contraseña Olvidada mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** que los usuarios puedan restablecer su contraseña en caso de olvidarla Para permitir que los usuarios recuperen el acceso a sus cuentas en caso de olvidar su contraseña</p>  |3| Elias Yauri                     |Done|
| TS07                |**Verificar Correo Electrónico**	|W07|Verificar Correo Electrónico mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API para que los usuarios puedan verificar su dirección de correo electrónico después del registro</p><p>**Para** garantizar la autenticidad de las cuentas de usuario en nuestra plataforma</p> |3| Elias Yauri                     |Done|
| TS08                |**Recuperar Preguntas de Entrevista**	|W08|Recuperar Preguntas de Entrevista mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** que los usuarios puedan recuperar preguntas de entrevista técnicas Para ayudar a los usuarios en su preparación para entrevistas técnicas.</p>                                |3| Adriano Cruz                    |Done|
| TS09                |**Registrar Actividad de Usuario**	|W09|Registrar Actividad de Usuario mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace **Quiero** proporcionar una API</p><p>Para que podamos registrar la actividad de los usuarios en la plataforma Para analizar el compromiso de los usuarios y mejorar la experiencia del usuario	</p>                               |3| Andrea Cabanillas               |Done|
| TS10                |**Eliminar Cuenta de Usuario**	|W10|Eliminar Cuenta de Usuario mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** que los usuarios puedan eliminar permanentemente sus cuentas Para permitir a los usuarios retirarse completamente de nuestra plataforma si así lo desean</p>                  |2| Andrea Cabanillas               |Done|
| TS11                |**Registrar Tutor**	|W11|Registrar Tutor mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** permitir que los tutores se inscriban en nuestra plataforma y puedan ofrecer sus servicios de tutoría a los usuarios.</p>                  |2| Jeremy Quispe               |To do|
| TS12                |**Obtener Planes**	|W12|Obtener Planes mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** permitir que los usuarios puedan visualizar los diferentes planes disponibles en nuestra plataforma y seleccionar el que más les convenga.</p>                  |3| Andrea Cabanillas               |To do|
| TS13                |**Registrar Participación en Concurso**	|W13|Registrar Participación en Concurso mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** permitir que los usuarios se inscriban en concursos de programación y demuestren sus habilidades técnicas.</p>                  |3| Elias Yauri               |To do|
| TS14                |**Evaluación Técnica**	|W14|Proporcionar Evaluación Técnica mediante una API	| <p>**Como** desarrollador que trabaja en la aplicación de CodePace</p><p>**Quiero** proporcionar una API</p><p>**Para** permitir que los usuarios tomen evaluaciones técnicas y midan sus conocimientos en áreas específicas de programación.</p>                  |4| Sebastian Cachis               |To do|
...
Recomendacion: Arreglar el diseño y centrar la barra de menu para que sea mas agradable a la vista del usuario
...
| **Sprint 3 Retrospective Summary** | Completar los diseños y estandarizar el lenguaje usado en el desarrollo y presentación las APIS RESTFUL                                                                                                                                                                                       |
| **Sprint Goal & User Stories**     |                                                                                                                                                                                                                                                                                               |
| **Sprint 4 Goal**                  | Creación de nuestra API REST para el funcionamiento de nuestra app web.                                                                                                                                                                                                                       |
| **Sprint 4 Velocity**              | 65                                                                                                                                                                                                                                                                                            |
| **Sum of Story Points**            | 65                                                                                                                                                                                                                                                                                            |

Reunión realizada a través de Google Meet, para organizar y resolver acuerdos dentro de nuestro equipo, para esta entrega final.

![image](https://github.com/CodepaceOrganization/Reports/assets/134337719/01b1a920-7c5b-460f-aa6f-2ec83e815d71)


**5.2.4.2.Sprint Backlog 4.**


<table><tr><th valign="top"><b>Sprint 4</b></th><th colspan="6" valign="top"><b>Sprint 4</b></th><th valign="top"></th></tr>
<tr><td colspan="2" valign="top"><b>Technical Story</b></td><td colspan="5" valign="top"><b>Work-Item / Task</b></td><td valign="top"></td></tr>
<tr><td valign="top"><p></b> </p><p><b>Id</b></p></td><td valign="top"><p></b> </p><p><b>Title</b></p></td><td valign="top"><p></b> </p><p><b>Id</b></p></td><td valign="top"><p></b> </p><p><b>Title</b></p></td><td valign="top"><p></b> </p><p><b>Description</b></p></td><td valign="top"><b>Estimation (Hours)</b></td><td valign="top"><p></b> </p><p><b>Assigned To</b></p></td><td valign="top"><b>Status(To do/In process/To review/Done)</b></td></tr>
<tr><td rowspan="2" valign="top">TS01</td><td rowspan="2" valign="top"><p><b>Registrar Usuario</b></p><p></p></td><td valign="top">W01</td><td valign="top">Registrar usuario mediante una api</td><td valign="top"><b>Como</b> desarrollador<br><b>Quiero</b> poder registrar a un nuevo usuario mediante una API <b>para</b> poder hacer testing dentro de la aplicación.</td><td valign="top">2</td><td valign="top">Jeremy Quispe</td><td valign="top">Done</td></tr>
<tr><td valign="top">W02</td><td valign="top">Autenticar usuario mediante una API</td><td valign="top"><b>Como</b> desarrollador, <b>quiero</b> poder autenticar a un usuario mediante una API <b>para</b> garantizar que solo los usuarios autorizados puedan acceder a sus perfiles y datos.</td><td valign="top">2</td><td valign="top"><p>Alexander</p><p>Castillo</p></td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS02</td><td rowspan="2" valign="top"><b>Iniciar Sesión de Usuario</b>	</td><td valign="top">W03</td><td valign="top">Quiero proporcionar una API para que los usuarios inicien sesión en sus cuentas.</td><td valign="top"><b>Como</b> desarrollador que trabaja en la aplicación de CodePace <b>Quiero</b> proporcionar una API para que los usuarios inicien sesión en sus cuentas <b>Para</b> permitirles acceder a su contenido personalizado y continuar con sus actividades de preparación para entrevistas técnicas	</td><td valign="top">2</td><td valign="top">Sebastian Cachis</td><td valign="top">To review</td></tr>
<tr><td valign="top">W04</td><td valign="top">` `Verificar seguridad de sesión mediante una API</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API <b>para</b> verificar la seguridad de las sesiones de usuario, para prevenir accesos no autorizados y mejorar la seguridad general de la plataforma.</td><td valign="top">3</td><td valign="top">Elias Yauri</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS03</td><td rowspan="2" valign="top"><p><b>Obtener Detalles del Usuario</b>	</p><p></p><p></p></td><td valign="top">W05</td><td valign="top"><p>Obtener Detalles del Usuario	</p><p></p><p></p></td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace</p><p><b>Quiero</b> proporcionar una API para que los usuarios recuperen sus detalles de perfil <b>Para</b> que puedan ver y actualizar su información personal cuando sea necesario.</p></td><td valign="top">1</td><td valign="top"><p>Jeremy</p><p>Quispe</p></td><td valign="top">Done</td></tr>
<tr><td valign="top">W06</td><td valign="top">Cerrar sesión automáticamente mediante una API</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API que cierre automáticamente las sesiones de los usuarios después de un período de inactividad, <b>para</b> proteger sus cuentas y datos en caso de que olviden cerrar sesión manualmente.</td><td valign="top">2</td><td valign="top"><p>Alexander</p><p>Castillo</p></td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS04</td><td rowspan="2" valign="top"><p><b>Actualizar Detalles del Usuario</b>	</p><p></p><p></p></td><td valign="top">W07</td><td valign="top">Actualizar Detalles del Usuario	</td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace</p><p><b>Quiero</b> proporcionar una API</p><p><b>Para</b> que los usuarios actualicen su información de perfil Para que puedan mantener sus datos personales actualizados en nuestra plataforma</p></td><td valign="top">3</td><td valign="top"><p>Alexander</p><p>Castillo</p></td><td valign="top">Done</td></tr>
<tr><td valign="top">W08</td><td valign="top">Validar datos de usuario mediante una API</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API para validar los datos ingresados por los usuarios al actualizar su perfil, asegurando que la información sea precisa y cumpla con los estándares requeridos.</td><td valign="top">2</td><td valign="top">Adriano Cruz</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS05</td><td rowspan="2" valign="top"><b>Cerrar Sesión de Usuario</b>	</td><td valign="top">W09</td><td valign="top">Cerrar Sesión de Usuario	</td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace</p><p><b>Quiero</b> proporcionar una API</p><p><b>Para</b> que los usuarios cierren sesión en sus cuentas para garantizar la seguridad y la privacidad de sus datos cuando finalicen su sesión en la plataforma</p></td><td valign="top">2</td><td valign="top">` `Jeremy Quispe</td><td valign="top">Done</td></tr>
<tr><td valign="top">W10</td><td valign="top">Limpiar sesiones activas al cerrar sesión mediante una API</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API para limpiar automáticamente todas las sesiones activas del usuario al cerrar sesión, <b>para</b> asegurar que no queden sesiones sin cerrar que puedan comprometer la seguridad del usuario.</td><td valign="top">1</td><td valign="top">Sebastian Cachis</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS06</td><td rowspan="2" valign="top"><b>Recuperar Contraseña Olvidada</b>	</td><td valign="top">W11</td><td valign="top">Recuperar Contraseña Olvidada	</td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace</p><p><b>Quiero</b> proporcionar una API</p><p><b>Para</b> que los usuarios puedan restablecer su contraseña en caso de olvidarla Para permitir que los usuarios recuperen el acceso a sus cuentas en caso de olvidar su contraseña</p></td><td valign="top">3</td><td valign="top">Elias Yauri</td><td valign="top">Done</td></tr>
<tr><td valign="top">W12</td><td valign="top">Verificar identidad del usuario antes de recuperar contraseña</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API que verifique la identidad del usuario mediante preguntas de seguridad o envío de un código de verificación al correo electrónico registrado, <b>para</b> asegurar que solo el propietario legítimo de la cuenta pueda restablecer la contraseña.</td><td valign="top">1</td><td valign="top">Jair Castillo</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS07</td><td rowspan="2" valign="top"><b>Verificar Correo Electrónico</b>	</td><td valign="top">W13</td><td valign="top">Verificar Correo Electrónico	</td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace</p><p><b>Quiero</b> proporcionar una API para que los usuarios puedan verificar su dirección de correo electrónico después del registro</p><p><b>Para</b> garantizar la autenticidad de las cuentas de usuario en nuestra plataforma</p></td><td valign="top">3</td><td valign="top">Elias Yauri</td><td valign="top">Done</td></tr>
<tr><td valign="top">W14</td><td valign="top">Registrar intentos de verificación de correo electrónico</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API que registre todos los intentos de verificación de correo electrónico, incluyendo éxitos y fallos, <b>para</b> ayudar a identificar posibles actividades fraudulentas y mejorar las medidas de seguridad.</td><td valign="top">2</td><td valign="top">Andrea Cabanillas</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS08</td><td rowspan="2" valign="top"><b>Recuperar Preguntas de Entrevista</b>	</td><td valign="top">W15</td><td valign="top">Recuperar Preguntas de Entrevista	</td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace</p><p><b>Quiero</b> proporcionar una API</p><p><b>Para</b> que los usuarios puedan recuperar preguntas de entrevista técnicas Para ayudar a los usuarios en su preparación para entrevistas técnicas.</p></td><td valign="top">3</td><td valign="top">Adriano Cruz</td><td valign="top">Done</td></tr>
<tr><td valign="top">W16</td><td valign="top">Filtrar preguntas de entrevista por nivel de dificultad</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API que permita a los usuarios filtrar las preguntas de entrevista técnicas por nivel de dificultad, <b>para que</b> puedan practicar de manera más eficiente según su nivel de habilidad.</td><td valign="top">2</td><td valign="top">Jeremy Quispe</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS09</td><td rowspan="2" valign="top"><b>Registrar Actividad de Usuario</b>	</td><td valign="top">W17</td><td valign="top">Registrar Actividad de Usuario	</td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace <b>Quiero</b> proporcionar una API</p><p><b>Para que</b> podamos registrar la actividad de los usuarios en la plataforma Para analizar el compromiso de los usuarios y mejorar la experiencia del usuario	</p></td><td valign="top">3</td><td valign="top">Andrea Cabanillas</td><td valign="top">Done</td></tr>
<tr><td valign="top">W18</td><td valign="top">Analizar patrones de uso de la plataforma</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API que analice los patrones de uso de los usuarios en la plataforma, <b>para</b> identificar las áreas más y menos utilizadas y así optimizar los recursos y funcionalidades ofrecidas.</td><td valign="top">2</td><td valign="top">Sebastian Cachis</td><td valign="top">Done</td></tr>
<tr><td rowspan="2" valign="top">TS10</td><td rowspan="2" valign="top"><b>Eliminar Cuenta de Usuario</b>	</td><td valign="top">W19</td><td valign="top">Eliminar Cuenta de Usuario	</td><td valign="top"><p><b>Como</b> desarrollador que trabaja en la aplicación de CodePace</p><p><b>Quiero</b> proporcionar una API</p><p><b>Para</b> que los usuarios puedan eliminar permanentemente sus cuentas Para permitir a los usuarios retirarse completamente de nuestra plataforma si así lo desean</p></td><td valign="top">2</td><td valign="top">Jair Castillo</td><td valign="top">Done</td></tr>
<tr><td valign="top">W20</td><td valign="top">Archivar Datos del Usuario</td><td valign="top"><b>Como</b> desarrollador en la aplicación de CodePace, <b>quiero</b> proporcionar una API que archive automáticamente los datos de los usuarios antes de eliminar sus cuentas, <b>para</b> cumplir con las normativas de protección de datos y permitir una posible recuperación en el caso de que el usuario decida reactivar su cuenta.</td><td valign="top">3</td><td valign="top">Jeremy Quispe</td><td valign="top">Done</td></tr>
</table>
...
Este sprint ha marcado un hito significativo en nuestra trayectoria hacia la innovación y la mejora continua. La integración tecnológica lograda ha sido producto de un enfoque iterativo y centrado en el usuario, donde cada funcionalidad ha sido cuidadosamente diseñada y probada para asegurar su eficacia y eficiencia. El éxito de esta fase no solo demuestra la capacidad técnica del equipo, sino también su habilidad para trabajar de manera sinérgica bajo la guía de principios ágiles y una planificación estratégica enfocada en resultados concretos y medibles.

Además, la retroalimentación obtenida de los primeros usuarios ha sido invaluable, proporcionando insights críticos que han permitido refinamientos sucesivos y una mejor adaptación del producto a las necesidades reales del mercado. Esta interacción continua con la base de usuarios ha ayudado a fortalecer la propuesta de valor de CodePace, haciendo que cada iteración del producto no solo cumpla, sino que exceda las expectativas de nuestros usuarios.
...
- **Startup Profile y Solution Profile**
  - **Descripción General del Proyecto**: Introducción al contexto y los objetivos del proyecto, explicando cómo surgió la idea y cuál es la necesidad que busca satisfacer.
  - **Visión y Misión de la Startup**: Detalle de la visión a largo plazo de la startup y cómo el proyecto actual se integra en esta visión.
  - **Solución Propuesta**: Descripción técnica y funcional de la solución propuesta, incluyendo las tecnologías y herramientas seleccionadas.
  - **Metodología Utilizada**: Explicación de las metodologías de gestión de proyectos y desarrollo de software empleadas (por ejemplo, Scrum, Lean Startup).

**Capítulo II: Requirements Elicitation & Analysis**
- **Análisis Competitivo y Entrevistas**
  - **Análisis de Competidores**: Descripción de la investigación de mercado realizada para identificar competidores directos e indirectos, y análisis de sus fortalezas y debilidades.
  - **Proceso de Recolectar Requisitos**: Detalles sobre cómo se llevaron a cabo las entrevistas y otras técnicas de recolección de requisitos como encuestas o grupos focales.
  - **Refinamiento de la Propuesta de Valor**: Cómo la información recogida influyó en la modificación o confirmación de la propuesta de valor del producto o servicio.

**Capítulo III: Requirements Specification**
- **Mapping y User Stories**
  - **Impact Mapping**: Descripción del proceso de impact mapping utilizado para conectar los objetivos del negocio con la funcionalidad del software.
  - **Creación de Historias de Usuario**: Proceso de traducción de los requisitos recogidos en historias de usuario para facilitar la implementación por parte del equipo de desarrollo.

**Capítulo IV: Product Design**
- **Guidelines y Architectures**
  - **Directrices de Estilo**: Detalles sobre las guías de estilo definidas para asegurar una interfaz coherente y acorde a la identidad de marca.
  - **Arquitectura de Información**: Explicación de cómo se estructuró la información dentro de la aplicación para garantizar la usabilidad y accesibilidad.
  - **Diseño de Interfaz y Experiencia de Usuario**: Descripción de los prototipos de interfaz desarrollados y las iteraciones de diseño basadas en feedback de usuarios potenciales.

**Capítulo V: Product Implementation, Validation & Deployment**
- **Implementación y Validación**
  - **Implementación del Producto**: Relato de las fases de desarrollo, incluyendo desafíos técnicos superados y herramientas de desarrollo utilizadas.
  - **Manejo de la Configuración del Software**: Estrategias utilizadas para el control de versiones y gestión de cambios.
  - **Pruebas para Validar la Solución**: Descripción de las pruebas unitarias, pruebas de integración y pruebas de usuario realizadas para asegurar la calidad del producto.
  - **Despliegue del Producto**: Métodos y plataformas utilizadas para el despliegue del producto final, y cómo se planificó el lanzamiento al mercado.
...
- Enlace para acceder la aplicación web: [Ver enlace](https://getworkwebsite.netlify.app/)
...
-  Video exposición TP: [Ver enlace](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210846_upc_edu_pe/EZE4wqKRjF9Ph4wsMi3twNkBsek3LKLfIdRFZe3gIltf8Q?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=4CsQah)
-  Video exposición TB2: [Ver enlace](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210846_upc_edu_pe/EXF1-cu030tNmOHVrLK50z0BsXILj0Q1Ow-umAA9orWERg?e=RIkYTL&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)
-  Video exposición TF1: [Ver enlace](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210846_upc_edu_pe/EWaULIxtCk5PmwhtpKM4djwBx3Lfe0je3yT-mWI0gXcHew?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=1ghPzL)
